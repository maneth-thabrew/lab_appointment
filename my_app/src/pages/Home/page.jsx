                    ...
                    <div className="grid grid-cols-1 place-items-center md:grid-cols-2 lg:grid-cols-3 gap-6">
                        {
                            ...
                            {
                                return (
                                    <div key={e.id} className="w-full h-full p-4 flex items-center justify-between bg-slate-100 rounded-2xl shadow-lg">
                                        <div className="flex flex-col gap-1">
                                            <h3 className="text-lg font-semibold">{e.title}</h3>
                                            <h5 className="text-2xl font-semibold text-orange-700">{e.todayAppointments}</h5>
                                        </div>
                                        <div>
                                            <i>{e.icon}</i>
                                        </div>
